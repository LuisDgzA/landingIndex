<header>
    <div class="topbar color-white shadow">
        <div class="topbar-top w-100 d-flex quitar-menu">
        ...
        <div class="topbar-menu d-flex align-items-center">
            <div class="topbar-menu__home all-centered quitar-menu">
            ...
            <div class="topbar-menu__navbar">
                <nav>
                    <ul class="d-flex justify-content-around">
                        ...
                        <li>
                            <a href="preparatoria.php" class="quitar-menu">Preparatoria</a>
                        </li>
                        <li>
                            <a href="licenciatura.php" class="quitar-menu">Licenciatura</a>
                        </li>
                        <li>
