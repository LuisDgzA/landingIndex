			...
			<div class="container contenedor-eventos">
				...
				<div class="d-flex cards-eventos-bottom">
					...
					<div class="col-12 col-xl-4">
						<div class="d-flex align-items-center justify-content-between proximosEventos">
							<div class="f-20 bold header-proximos-eventos">
					...
					<div class="card-oferta-academica__buttons d-flex justify-content-between">
						...
						<div class="container-ver-cursos">
							<button class="btn-styless">
								<div class="btn-ver-cursos bold">Ver cursos</div>
							</button>
						</div>
					</div>
				</div>
