    ...
    <header>
        <div class="topbar color-white">
            <div class="topbar-top w-100 d-flex">
                ...
                <div>
                    <button class="upper button-gral" id="btnIngresoAlumnos">ingreso alumnos</button>
                </div>
            </div>
            ...
            <div class="intro-container">
                <div class="intro__servicios">
                    <div class="servicio-intro col-3">
                        <div class="servicio-intro__icon border-red">
                            icono
                        </div>
                ...
                <div class="intro__imagenes border-red">
                    ...
                    <div class="intro__imagenes-text col-6">
                        ...
                        <p class="mt-3">En index hemos creado para ti la Universidad index que será el mejor medio para que desarolles las competencias que te permitan desempeñar con éxito tus actividades laborales y crecer de manera personal y profesional.</p>
                        <button class="button-gral" id="btnQuieroInscribirme">Quiero inscribirme</button>
                    </div>
                </div>
            </div>
        </section>
    ...
    <main>
        <section id="acerca" class="">
            ...
            <div class="col-7">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Molestiae aperiam labore eaque, nesciunt repellendus repellat eum corporis enim natus perferendis sed recusandae, nulla sit amet magni sunt itaque quos dolorum dignissimos deserunt iste reiciendis ipsam. Odit aut error quas placeat!</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum doloribus assumenda eveniet at natus molestias incidunt dolorum dolores? Veniam, commodi! orem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum doloribus assumenda eveniet at natus molestias incidunt dolorum dolores? Veniam, commod</p>
        ...
        <section id="acercaBottom">
            <div class="container d-flex contenedor-acerca">
                ...
                <div class="col-3 d-flex flex-column card-items-acerca">
                    ...
                    <div class="text-about-bottom">
                        Asignaturas y cursos relevantes y actualizados desarrollados por docentes especializados.
                    </div>
                </div>
                <div class="col-3 d-flex flex-column card-items-acerca">
                    <div>
                    ...
                    <div class="text-about-bottom">
                        Accede a videos, casos, lecturas, foros de discusión y actividades integradoras que facilitan el aprendizaje.
                    </div>
                </div>
                <div class="col-3 d-flex flex-column card-items-acerca">
                    <div>
                    ...
                    <div class="text-about-bottom">
                        Cada estudiante decide las horas y días de estudio y de presentación de exámenes.
                    </div>
                </div>
            </div>
        </section>
